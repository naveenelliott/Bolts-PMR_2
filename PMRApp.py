...
in_and_out_goals_gk = pd.read_csv('PostMatchReviewApp_v3/pages/InAndOutOfPossessionGoalsGK.csv')
...
in_and_out_goals = pd.read_csv('PostMatchReviewApp_v3/pages/InAndOutOfPossessionGoals.csv')
